...
@dataclass(frozen=True)
class EmbeddingSpec:
    """Pinned physical embedding property generated by a connector runtime."""
    ...
    def __post_init__(self) -> None:
        _identifier(self.source_column, name="embedding source column")
        _identifier(self.property_name, name="embedding property name")
        ...
        if not isinstance(self.revision, str) or not self.revision:
            raise ValueError("embedding revision must be a non-empty string")
