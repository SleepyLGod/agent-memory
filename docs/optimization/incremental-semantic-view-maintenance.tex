...
defines semantic membership, and \texttt{sem\_agg} produces the output row for
each group. Future APIs may add deterministic grouped aggregates, but v0 uses
the chain form \texttt{sem\_groupby(...).sem\_agg(...)}.
